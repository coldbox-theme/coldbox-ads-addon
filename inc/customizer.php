			...
			new WP_Customize_Control(
				...
				array(
					...
					'description' => sprintf(
						...
						esc_html__( 'Publisher ID is the identifier of your AdSense account and its format is something like this: "ca-pub-XXXXXXXXXXXXX" (It may start with "pub-" for some users). %1$sGo here%2$s to learn how to find your publisher ID.', 'coldbox-ads-extension' ),
