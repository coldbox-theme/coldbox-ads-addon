...
class Coldbox_Ads_Content {
	...
	public function matched_content() {
		...
		echo $ad; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
	}
	...
	public function in_feed( $count ) {
		...
		if ( in_array( $count, $ads_array, true ) ) {
			...
			echo '<article class="post-ad post">' . $ad . '</article>'; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
		}
	}
